...
# P_HOGAR: ¿Cuántas personas viven en tu hogar (incluyéndote)?
# Restricción: número entero mayor o igual a 1
PERSONAS_HOGAR_MIN = 1

# P_VIVIENDA: ¿La vivienda es propia o alquilada?
# Restricción: lista desplegable — propia | alquilada
OPCIONES_VIVIENDA = {"propia", "alquilada", "familiar"}

# P_LABORAL: ¿Cuál es tu situación laboral actual?
# Restricción: lista desplegable — Empleado | Desempleado | Estudiante | Independiente | Jubilado
